              ...
              Padding(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    if (adSoyad.isNotEmpty && email.isNotEmpty && selectedBlok != null && aciklama
                  .isNotEmpty) {
                            CollectionReference feedbackKayitlarRef =
                            FirebaseFirestore.instance.collection('feedbackKayitlar');

                            feedbackKayitlarRef.doc(selectedBlok).collection('kayitlar').add({
                                'adSoyad': adSoyad,
                                'email': email,
                                'aciklama': aciklama,
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    content: const Text('Geri bildirim formu başarıyla gönderildi.'),
                                    actions: [
                                      TextButton(
